...
public final class StudentAnalytics {
    ...
    public double averageAgeOfEnrolledStudentsParallelStream(
            final Student[] studentArray) {
        double ages = Stream.of(studentArray)
                .parallel()
    ...
    public String mostCommonFirstNameOfInactiveStudentsParallelStream(
            final Student[] studentArray) {
        ConcurrentHashMap<String, Integer> nameCounts = new ConcurrentHashMap<String, Integer>();
        ...
        List<String> nombres = nameCounts.entrySet()
                .stream()
                .parallel()
                .sorted(ConcurrentHashMap.Entry.comparingByValue())
